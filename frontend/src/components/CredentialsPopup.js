    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-[#1E293B] border-slate-700 text-white max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4 sm:space-y-6 py-3 sm:py-4">
          ...
          <div className="bg-slate-800/50 rounded-lg p-3 sm:p-4 border border-slate-700">
            <div className="flex items-center gap-2 sm:gap-3 mb-3">
              <Lock className="w-4 h-4 sm:w-5 sm:h-5 text-orange-400 flex-shrink-0" />
              <h3 className="font-semibold text-base sm:text-lg">Mot de passe temporaire</h3>
            </div>
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
              <div className="flex-1 bg-slate-900 rounded px-3 sm:px-4 py-2 sm:py-3 font-mono text-xs sm:text-sm border border-slate-700 flex items-center justify-between">
                <span className="break-all flex-1">{showPassword ? displayPassword : '••••••••••••'}</span>
                <button
